...
// 15. Premium adjustment sliders icon for Properties panel
export function SlidersIcon({ size = 14, color = 'currentColor', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 16. Chained relationship link icon for Backlinks panel
export function LinkIcon({ size = 14, color = 'currentColor', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 17. Price tag icon for tags list
export function TagIcon({ size = 14, color = 'currentColor', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 18. Document outline/Table of Contents icon
export function OutlineIcon({ size = 14, color = 'currentColor', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <line x1="8" y1="6" x2="21" y2="6" strokeWidth="2.2" />
      <line x1="8" y1="12" x2="21" y2="12" strokeWidth="2.2" />
      <line x1="8" y1="18" x2="21" y2="18" strokeWidth="2.2" />
